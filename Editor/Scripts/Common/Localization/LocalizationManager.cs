...
namespace com.MiAO.MCP.Editor.Common
{
    ...
    public static class LocalizationManager
    {
        ...
        {
            [Language.English] = "Assets/MiAO-MCP/Editor/Scripts/Common/Localization/Language/en.json",
            [Language.ChineseSimplified] = "Assets/MiAO-MCP/Editor/Scripts/Common/Localization/Language/zh-CN.json"
        };
