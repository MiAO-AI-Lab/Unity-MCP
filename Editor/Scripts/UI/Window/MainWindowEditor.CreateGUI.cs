...
namespace com.MiAO.MCP.Editor
{
    public partial class MainWindowEditor : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            var templateControlPanel = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/MiAO-MCP-for-Unity/Editor/UI/uxml/AiConnectorWindow.uxml");
            if (templateControlPanel == null)
            {
                Debug.LogError("'templateControlPanel' could not be loaded from path: Assets/MiAO-MCP-for-Unity/Editor/UI/uxml/AiConnectorWindow.uxml");
                return;
            }

            // Load and apply the stylesheet
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/MiAO-MCP-for-Unity/Editor/UI/uss/AiConnectorWindow.uss");
            if (styleSheet != null)
            {
            ...
            {
                Debug.LogWarning("Could not load stylesheet from: Assets/MiAO-MCP-for-Unity/Editor/UI/uss/AiConnectorWindow.uss");
            }
                ...
                .Subscribe(tuple =>
                {
                    ...
                    if (logoElement != null)
                    {
                        var logoPath = isConnected
                            ? "Assets/MiAO-MCP-for-Unity/Editor/Gizmos/512_logo_conneted.png"
                            : "Assets/MiAO-MCP-for-Unity/Editor/Gizmos/logo_512.png";
